...
QT_MOC_LITERAL(1, 5, 9), // "sendClose"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(4, 40, 11), // "sendemotion"
QT_MOC_LITERAL(5, 52, 1), // "s"
QT_MOC_LITERAL(6, 54, 11) // "refreshText"

    },
    "Chat\0sendClose\0\0on_pushButton_2_clicked\0"
    "sendemotion\0s\0refreshText"
};
...
void Chat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->sendemotion((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->refreshText(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Chat::sendClose)) {
                *result = 0;
                return;
            }
        }
