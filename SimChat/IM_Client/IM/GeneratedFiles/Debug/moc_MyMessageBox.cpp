...
QT_MOC_LITERAL(1, 13, 11), // "m_mboxclose"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 11) // "mboxClicked"

    },
    "MyMessageBox\0m_mboxclose\0\0mboxClicked"
};
...
void MyMessageBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->m_mboxclose(); break;
        case 1: _t->mboxClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyMessageBox::m_mboxclose)) {
                *result = 0;
                return;
            }
        }
